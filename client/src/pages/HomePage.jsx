      ...
      >
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex space-x-3">
            <Link to="/login" className="px-6 py-2 border border-gray-300 rounded-full font-medium text-gray-700 btn-outline-hover transition-all duration-300">
              Log In
            </Link>
            <Link to="/register" className="px-6 py-2 bg-blue-800 text-white rounded-full font-medium btn-hover transition-all duration-300">
              Sign Up
            </Link>
          </div>
        ...
        <div className={`md:hidden mt-4 transition-all duration-300 ${isMenuOpen ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
          <div className="flex flex-col space-y-4 pb-4">
            ...
            <div className="flex space-x-3 pt-2">
              <button className="px-4 py-2 border border-gray-300 rounded-full font-medium text-gray-700">
                Log In
              </button>
              <button className="px-4 py-2 bg-blue-800 text-white rounded-full font-medium">
                Sign Up
              </button>
            </div>
          </div>
