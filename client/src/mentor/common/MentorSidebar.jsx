...
import { FaUser, FaCode, FaProjectDiagram, FaGraduationCap, FaChalkboardTeacher, FaChevronRight, FaChartLine, FaUserGraduate, FaCheckCircle } from "react-icons/fa";
...
// subLinks:[]
      ...
      {
        name: "Tutorials",
        href: "/mentor/tutorials",
        icon: <FaChalkboardTeacher />,
        subLinks: [],
      },
      {
        name: "Skill Verification",
        href: "/mentor/skill-verification",
        icon: <FaCheckCircle />,
        subLinks: [],
      },
